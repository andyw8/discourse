...
#
# source://sprockets//lib/sprockets/version.rb#1
module Sprockets
...
#
# source://sprockets//lib/sprockets/directive_processor.rb#36
class Sprockets::DirectiveProcessor
  # @return [DirectiveProcessor] a new instance of DirectiveProcessor
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#63
  def initialize(options = T.unsafe(nil)); end

  # source://sprockets//lib/sprockets/directive_processor.rb#71
  def _call(input); end

  # source://sprockets//lib/sprockets/directive_processor.rb#67
  def call(input); end
  ...
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#99
  ...
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#136
  ...
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#275
  ...
  #     //= depend_on "foo.png"
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#260
  ...
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#177
  ...
  #   /*= link "logo.png" */
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#299
  ...
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#330
  ...
  #     //= require "./bar"
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#206
  ...
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#233
  ...
  #      */
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#220
  ...
  #     //= require_tree "./public"
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#243
  def process_require_tree_directive(path = T.unsafe(nil)); end

  # source://sprockets//lib/sprockets/directive_processor.rb#113
  ...
  #     //= stub "jquery"
  #
  # source://sprockets//lib/sprockets/directive_processor.rb#287
  def process_stub_directive(path); end

  private

  # source://sprockets//lib/sprockets/directive_processor.rb#337
  ...
  # source://sprockets//lib/sprockets/directive_processor.rb#355
  def link_paths(paths, deps, accept); end

  # source://sprockets//lib/sprockets/directive_processor.rb#387
  def load(uri); end

  # source://sprockets//lib/sprockets/directive_processor.rb#349
  def require_paths(paths, deps); end

  # source://sprockets//lib/sprockets/directive_processor.rb#393
  def resolve(path, options = T.unsafe(nil)); end

  # source://sprockets//lib/sprockets/directive_processor.rb#361
  def resolve_paths(paths, deps, options = T.unsafe(nil)); end

  class << self
    # source://sprockets//lib/sprockets/directive_processor.rb#59
    def call(input); end

    # source://sprockets//lib/sprockets/directive_processor.rb#52
    def instance; end
  end
end
...
#     //= require "foo"
#
# source://sprockets//lib/sprockets/directive_processor.rb#48
...
# source://sprockets//lib/sprockets/environment.rb#6
...
class Sprockets::SassCompressor
  ...
  #
  # source://dartsass-sprockets/3.0.0/lib/sassc/rails/compressor.rb#7
  def initialize(options = T.unsafe(nil)); end
  ...
  # source://dartsass-sprockets/3.0.0/lib/sassc/rails/compressor.rb#17
  def call(*args); end
...
module Sprockets::SassProcessor::Functions
  ...
  #
  # source://dartsass-sprockets/3.0.0/lib/sassc/rails/functions.rb#7
...
module Sprockets::URIUtils
  ...
  # Returns String URI.
  #
  # source://sprockets//lib/sprockets/uri_utils.rb#111
  ...
  # Returns String URI.
  #
  # source://sprockets//lib/sprockets/uri_utils.rb#145
  ...
  #
  # source://sprockets//lib/sprockets/uri_utils.rb#154
  ...
  # Returns String.
  #
  # source://sprockets//lib/sprockets/uri_utils.rb#59
  ...
  #
  # source://sprockets//lib/sprockets/uri_utils.rb#90
  ...
  # Returns String path.
  #
  # source://sprockets//lib/sprockets/uri_utils.rb#125
  ...
  #
  # source://sprockets//lib/sprockets/uri_utils.rb#179
  ...
  # @return [Boolean]
  #
  # source://sprockets//lib/sprockets/uri_utils.rb#73
...
module Sprockets::Utils
  ...
  #
  # source://sprockets//lib/sprockets/utils.rb#190
  def dfs(initial); end
  ...
  #
  # source://sprockets//lib/sprockets/utils.rb#217
  ...
  #
  # source://sprockets//lib/sprockets/utils.rb#155
  ...
  #     # => ".css"
  #
  # source://sprockets//lib/sprockets/utils.rb#130
...
#
# source://sprockets//lib/sprockets/utils.rb#142
