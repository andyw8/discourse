...
class Aws::Sigv4::Signer
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#133
  def initialize(options = T.unsafe(nil)); end
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#394
  def presign_url(options); end

  # @return [String]
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#158
  def region; end
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#307
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#226
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#719
  def crt_fetch_credentials; end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#787
  def crt_presign_url(options); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#728
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#469
  ...
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#619
  def hexhmac(key, value); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#615
  def hmac(key, value); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#587
  def host(uri); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#532
  def normalized_querystring(querystring); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#522
  def path(url); end
  ...
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#496
  def signature(secret_access_key, date, string_to_sign); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#561
  def signed_headers(headers); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#451
  ...
  class << self
    # @api private
    #
    # source://aws-sigv4//lib/aws-sigv4/signer.rb#850
    def uri_escape(string); end

    # @api private
    #
    # source://aws-sigv4//lib/aws-sigv4/signer.rb#845
    def uri_escape_path(path); end

    # @return [Boolean]
    #
    # source://aws-sigv4//lib/aws-sigv4/signer.rb#835
    def use_crt?; end
  end
end
