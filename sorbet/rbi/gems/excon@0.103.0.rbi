...
#
# source://excon//lib/excon/constants.rb#137
...
# source://excon//lib/excon/constants.rb#113
...
class Excon::Socket
  ...
  # source://excon//lib/excon/socket.rb#193
  def add_to_read_buffer(str); end

  # source://excon//lib/excon/socket.rb#111
  def connect; end

  # source://excon//lib/excon/socket.rb#240
  def read_block(max_length); end

  # source://excon//lib/excon/socket.rb#198
  def read_nonblock(max_length); end

  # source://excon//lib/excon/socket.rb#299
  def select_with_timeout(socket, type); end

  # source://excon//lib/excon/socket.rb#313
  def unpacked_sockaddr; end

  # source://excon//lib/excon/socket.rb#289
  def write_block(data); end

  # source://excon//lib/excon/socket.rb#254
...
# source://excon//lib/excon/constants.rb#69
