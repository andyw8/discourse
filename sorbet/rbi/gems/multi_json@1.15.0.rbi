...
# source://multi_json//lib/multi_json/adapters/oj.rb#6
module MultiJson::Adapters; end

# Use the Oj library to dump/load.
#
# source://multi_json//lib/multi_json/adapters/oj.rb#8
class MultiJson::Adapters::Oj < ::MultiJson::Adapter
  # source://multi_json//lib/multi_json/adapters/oj.rb#54
  def dump(object, options = T.unsafe(nil)); end

  # source://multi_json//lib/multi_json/adapters/oj.rb#32
  def load(string, options = T.unsafe(nil)); end
...
# source://multi_json//lib/multi_json/adapters/oj.rb#45
MultiJson::Adapters::Oj::PRETTY_STATE_PROTOTYPE = T.let(T.unsafe(nil), Hash)
...
# (at least for now).
#
# source://multi_json//lib/multi_json/adapters/oj.rb#19
class MultiJson::Adapters::Oj::ParseError < ::SyntaxError
  class << self
    # source://multi_json//lib/multi_json/adapters/oj.rb#22
    def ===(exception); end
  end
end

# source://multi_json//lib/multi_json/adapters/oj.rb#20
MultiJson::Adapters::Oj::ParseError::WRAPPED_CLASSES = T.let(T.unsafe(nil), Set)
