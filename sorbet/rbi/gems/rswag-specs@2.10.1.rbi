...
module Rswag::Specs
  class << self
    # source://rswag-specs//lib/rswag/specs.rb#22
    def config; end
  end
end
...
class Rswag::Specs::Configuration
  ...
  # source://rswag-specs//lib/rswag/specs/configuration.rb#59
  def swagger_strict_schema_validation; end
end

# source://rswag-specs//lib/rswag/specs/configuration.rb#64
...
module Rswag::Specs::ExampleGroupHelpers
  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#39
  def consumes(*value); end

  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#16
  def delete(summary, **metadata, &block); end

  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#23
  ...
  #
  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#31
  def description(value = T.unsafe(nil)); end

  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#95
  ...
  #
  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#87
  ...
  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#78
  ...
  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#44
  def parameter(attributes); end

  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#16
  def patch(summary, **metadata, &block); end

  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#10
  ...
  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#58
  def request_body_example(value:, summary: T.unsafe(nil), name: T.unsafe(nil)); end

  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#69
  ...
  # @return [void]
  #
  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#125
  def run_test!(description = T.unsafe(nil), *args, **options, &block); end

  # source://rswag-specs//lib/rswag/specs/example_group_helpers.rb#74
...
class Rswag::Specs::MissingParameterError < ::StandardError
  ...
  #
  # source://rswag-specs//lib/rswag/specs/request_factory.rb#285
  def initialize(body_param); end

  # Returns the value of attribute body_param.
  #
  # source://rswag-specs//lib/rswag/specs/request_factory.rb#283
  def body_param; end

  # source://rswag-specs//lib/rswag/specs/request_factory.rb#289
  def message; end
end
...
# source://rswag-specs//lib/rswag/specs.rb#28
...
class Rswag::Specs::RequestFactory
  ...
  #
  # source://rswag-specs//lib/rswag/specs/request_factory.rb#263
  ...
  # source://rswag-specs//lib/rswag/specs/request_factory.rb#273
  ...
  # source://rswag-specs//lib/rswag/specs/request_factory.rb#277
...
class Rswag::Specs::ResponseValidator
  ...
  # source://rswag-specs//lib/rswag/specs/response_validator.rb#84
...
# source://rswag-specs//lib/rswag/specs/response_validator.rb#99
