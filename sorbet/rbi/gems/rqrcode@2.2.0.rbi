...
module RQRCode::Export::SVG
  ...
  #                   (default {})
  #
  # source://rqrcode//lib/rqrcode/export/svg.rb#164
...
# source://rqrcode//lib/rqrcode/export/svg.rb#124
RQRCode::Export::SVG::DEFAULT_SVG_ATTRIBUTES = T.let(T.unsafe(nil), Array)

# source://rqrcode//lib/rqrcode/export/svg.rb#106
class RQRCode::Export::SVG::Edge < ::Struct
  # source://rqrcode//lib/rqrcode/export/svg.rb#107
  def end_x; end

  # source://rqrcode//lib/rqrcode/export/svg.rb#115
  def end_y; end
end
...
# source://rqrcode//lib/rqrcode/export/svg.rb#86
class RQRCode::Export::SVG::Rect < ::RQRCode::Export::SVG::BaseOutputSVG
  # source://rqrcode//lib/rqrcode/export/svg.rb#87
  def build(module_size, offset, color); end
end

# source://rqrcode//lib/rqrcode/export/svg.rb#131
