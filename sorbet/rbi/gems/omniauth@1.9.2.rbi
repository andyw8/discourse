...
module OmniAuth
  class << self
    # source://omniauth//lib/omniauth.rb#118
    def config; end

    # @yield [config]
    #
    # source://omniauth//lib/omniauth.rb#122
    def configure; end
    ...
    # source://omniauth//lib/omniauth.rb#19
    def strategies; end
  end
end
...
class OmniAuth::Builder < ::Rack::Builder
  ...
  # source://omniauth//lib/omniauth/builder.rb#44
  def call(env); end
...
# source://omniauth//lib/omniauth.rb#23
class OmniAuth::Configuration
  ...
  #
  # source://omniauth//lib/omniauth.rb#49
  def initialize; end
  ...
  # source://omniauth//lib/omniauth.rb#61
  def before_callback_phase(&block); end
  ...
  #
  # source://omniauth//lib/omniauth.rb#114
  def before_callback_phase=(_arg0); end

  # source://omniauth//lib/omniauth.rb#69
  def before_options_phase(&block); end
  ...
  # source://omniauth//lib/omniauth.rb#77
  def before_request_phase(&block); end
  ...
  # source://omniauth//lib/omniauth.rb#53
  def on_failure(&block); end
  ...
  class << self
    # source://omniauth//lib/omniauth.rb#26
    def default_logger; end

    # source://omniauth//lib/omniauth.rb#32
    def defaults; end
...
class OmniAuth::FailureEndpoint
  ...
  # source://omniauth//lib/omniauth/failure_endpoint.rb#40
  ...
  # source://omniauth//lib/omniauth/failure_endpoint.rb#34
...
class OmniAuth::Strategies::Twitter < ::OmniAuth::Strategies::OAuth
  ...
  # source://omniauth//lib/omniauth/strategy.rb#443
...
module OmniAuth::Strategy
  ...
  # source://omniauth//lib/omniauth/strategy.rb#347
  def auth_hash; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#419
  def call_app!(env = T.unsafe(nil)); end

  # Performs the steps necessary to run the callback phase of a strategy.
  #
  # source://omniauth//lib/omniauth/strategy.rb#231
  def callback_call; end

  # source://omniauth//lib/omniauth/strategy.rb#395
  def callback_path; end

  # source://omniauth//lib/omniauth/strategy.rb#371
  def callback_phase; end

  # source://omniauth//lib/omniauth/strategy.rb#443
  def callback_url; end

  # source://omniauth//lib/omniauth/strategy.rb#339
  def credentials; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#494
  def dup; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#343
  def extra; end

  # source://omniauth//lib/omniauth/strategy.rb#480
  def fail!(message_key, exception = T.unsafe(nil)); end

  # source://omniauth//lib/omniauth/strategy.rb#423
  def full_host; end

  # source://omniauth//lib/omniauth/strategy.rb#335
  def info; end
  ...
  # in test mode.
  #
  # source://omniauth//lib/omniauth/strategy.rb#270
  ...
  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#243
  def on_auth_path?; end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#255
  def on_callback_path?; end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#259
  def on_path?(path); end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#247
  ...
  #
  # source://omniauth//lib/omniauth/strategy.rb#196
  def options_call; end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#263
  def options_request?; end

  # source://omniauth//lib/omniauth/strategy.rb#376
  def path_prefix; end

  # source://omniauth//lib/omniauth/strategy.rb#415
  ...
  #
  # source://omniauth//lib/omniauth/strategy.rb#203
  def request_call; end

  # source://omniauth//lib/omniauth/strategy.rb#391
  ...
  #
  # source://omniauth//lib/omniauth/strategy.rb#327
  def request_phase; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#451
  def session; end

  # source://omniauth//lib/omniauth/strategy.rb#405
  def setup_path; end
  ...
  #
  # source://omniauth//lib/omniauth/strategy.rb#313
  def setup_phase; end
  ...
  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#364
  def skip_info?; end

  # source://omniauth//lib/omniauth/strategy.rb#331
  def uid; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#504
...
# source://omniauth//lib/omniauth/strategy.rb#410
...
module OmniAuth::Utils
  ...
  # source://omniauth//lib/omniauth.rb#156
  def camelize(word, first_letter_in_uppercase = T.unsafe(nil)); end

  # source://omniauth//lib/omniauth.rb#141
  def deep_merge(hash, other_hash); end

  # source://omniauth//lib/omniauth.rb#137
  def form_css; end
